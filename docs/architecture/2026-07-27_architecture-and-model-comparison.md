...
- **Measurement reliability.** The diagnostic estimates strength with **shrinkage toward 0.5** (few items → less confidence). The rigorous upgrade — noted as **roadmap, not built** — is **adaptive testing (CAT / Item Response Theory)**, the same principle as a long personality inventory: more observations → more confident bracketing.
