...
- Knowledge: Gamification for Dummies plus course material

## Roadmap

See `HANDOFF.md` §6 for the full 3-month breakdown. Current focus is Week 1: the architecture doc and model justification.

## Files

- `CLAUDE.md`: working brief and operations manual
- `HANDOFF.md`: project history, literature, and full spec
